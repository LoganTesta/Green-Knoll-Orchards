...
add_action( 'wp_enqueue_scripts', function() {
    ...
    wp_enqueue_style( 'main-styles', "" . get_stylesheet_directory_uri() . '/assets/css/main-styles.css?mod=11282025' );
    wp_enqueue_style( 'print-styles', "" . get_stylesheet_directory_uri() . '/assets/css/print-styles.css?mod=11282025', array(), '', 'print' );
